...
struct LinkInfo
{
   struct rarch_video_shader_pass *pass;
...
typedef struct shader_backend
{
   ...
   struct rarch_video_shader *(*get_current_shader)(void *data);
...
typedef struct rarch_video_shader_ctx_params
{
   void *data;
   const void *info;
...
typedef struct rarch_video_shader_ctx
{
   struct rarch_video_shader *data;
} video_shader_ctx_t;
...
#ifdef HAVE_MENU
   struct rarch_video_shader *menu_driver_shader;
#endif
